...
type NavVariant = 'bottom' | 'sidebar' | 'top' | 'responsive';
...
export function Header({ variant = 'responsive', showProfile = false }: NavbarProps) {
  ...
  // Responsive variant - automatically chooses based on screen size
  if (variant === 'responsive') {
    if (isMobile) {
      ...
      // Return sidebar for desktop
      return (
        <>
          {/* Sidebar */}
          <aside className="fixed top-0 left-0 h-full w-80 bg-gray-900 border-r border-gray-800 z-50">
